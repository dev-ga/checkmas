<div class="p-8 min-[420px]:-mt-16 md:mt-0">
    ...
    <div class="flex items-center justify-end mt-8">
        <button type="submit" wire:click.prevent="registrate()" class="ml-3 inline-flex justify-center py-2 px-4 text-sm font-bold text-check-blue shadow-sm">
    ...
    <div class="flex items-center justify-end mt-4">
        <button type="submit" wire:click.prevent="recuperar_pass()" class="ml-3 inline-flex justify-center py-2 px-4 text-sm font-bold text-check-blue shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" wire:loading wire:target="registrate" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="animate-spin h-5 w-5 mr-3">
                <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
              </svg>          
