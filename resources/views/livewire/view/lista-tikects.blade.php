                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                <div class="flex items-center gap-x-2">
                                    <div>
                                        <p class="text-xs font-bold text-gray-600 dark:text-gray-400">Agencia: {{ $item->agencia }}</p>
                                        <p class="text-xs font-bold text-gray-600 dark:text-gray-400">Estado: {{ $item->estado }}</p>
                                    </div>
                                </div>
                            </td>
                            
                            <td class="w-1/4 px-4 py-4 text-sm text-gray-500 text-justify dark:text-gray-300">{{ $item->observaciones }}</td>
