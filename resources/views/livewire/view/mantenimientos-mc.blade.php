                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-orange-500 bg-orange-100/60 dark:bg-gray-800">
                                    ...
                                    <div class="flex items-center gap-x-2 mr-8">
                                        <div>
                                            <h2 class="text-sm font-bold text-orange-500 dark:text-white ">Ejecuion</h2>
                                            <p class="text-xs font-normal text-orange-300 dark:text-gray-400">Orden de trabajo en ejecucion</p>
                                        </div>
                                    </div>
                                </div>
                            </td>
